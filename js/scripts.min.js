				...
				$.post(
					...
					.done(function (response) {
						...
						if (response.result === "error") {
							$("#alert-wrapper").html(
								alert_markup("danger", response.message)
							);
						} else {
							$("#alert-wrapper").html("");
...
document.addEventListener("DOMContentLoaded", function () {
	...
	form.addEventListener("submit", function (event) {
		...
		fetch(form.action, {
			...
			.then((response) => {
				if (response.ok) {
					// If the response is successful, hide the loading button
					...
					// Revert to the original button state
					loadingContainer.style.display = "none";
...
document.addEventListener("DOMContentLoaded", function () {
	...
	hadirRadioYes.addEventListener("change", updateJumlahKehadiranVisibility);
	hadirRadioNo.addEventListener("change", updateJumlahKehadiranVisibility);
